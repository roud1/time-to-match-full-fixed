import type { SparkDemoProfile } from "@/components/landing/spark-demo-profile-card"

/** Demo profiles for landing showcase (not real users). */
export const SPARK_DEMO_PROFILES: SparkDemoProfile[] = [
  {
    name: "Анна",
    age: 24,
    compatibility: 82,
