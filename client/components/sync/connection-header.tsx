...
import { stageLabel, streakMessage } from "@/client/lib/connection-system"
...
import type { TimelineMilestone } from "@/client/lib/connection-timeline"
import { deriveChatExperience, getChatExperienceLabel } from "@/client/lib/chat-emotional-experience"
import { getAIConnectionStateLabel } from "@/client/lib/ai-connection-engine"
import { ConnectionTimer } from "@/client/components/connection/connection-timer"
import { ConnectionProgress } from "@/client/components/sync/connection-progress"
import { SharedEnergyBar } from "@/client/components/sync/shared-energy-bar"
import { SyncTimeline } from "@/client/components/sync/sync-timeline"
...
} from "@/client/components/chat/connection"
import {
  RelationshipIdentityStrip,
  RelationshipStoryTimeline,
  MemoryCard,
} from "@/client/components/relationship"
...
export type ConnectionAnalysisBundle = {
  ...
  aiLoading: boolean
  aiEnhanced: boolean
  aiMemories?: import("@/client/lib/ai-connection-engine/types").AIMemoryMoment[]
}
